...
try {
    ...
    // Prevent admin from deleting themselves (if admin is a user)
    // Note: Since admin uses separate login, this check may not be needed
    // but we keep it for safety if admin is linked to a user account
    ...
    try {
        // Delete user's video analyses (and their video files)
        ...
        // Delete user's action predictions (and their video files)
        ...
        // Delete user identities if exists
