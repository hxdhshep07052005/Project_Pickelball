...
<head>
    ...
    <title>Verify Code - Admin Login</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <h1>Verify Code</h1>
                <p>Enter the verification code sent to your email<br><strong><?php echo htmlspecialchars($maskedEmail, ENT_QUOTES, 'UTF-8'); ?></strong></p>
            </div>
            <?php if ($notice): ?>
