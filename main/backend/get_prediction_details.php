<?php
/**
 * Backend handler to get action prediction details by ID
 * Returns JSON with prediction details including analysis data
 */
    ...
    try {
        ...
        if (!empty($prediction['analysis_raw_feedback'])) {
            ...
            if (is_array($decoded)) {
                ...
                // Try decoding again if it's a JSON string
                $decoded = json_decode($prediction['analysis_raw_feedback'], true);
